...
public class Sudoku {    
   ...
   /* checks for whether the row has the target value in it already */
   private boolean[][] checkCol;
   /* checks for whether the column already has the target value in it */
    ...
    public void placeVal(int val, int row, int col) {
        ...
        if(this.checkRow[row][val]== true || this.checkCol[col][val]==true || this.subgridHasVal[row/3][col/3][val]== true){
            return;

        }
        else{
            this.checkRow[row][val] = true;
            this.checkCol[col][val] = true;
    ...
    private boolean validCheck(int val, int row, int col){
        if(this.checkRow[row][val]==false&&this.checkCol[col][val]==false&&this.subgridHasVal[row/3][col/3][val]==false){
            return true;
        }
        return false;
    }
